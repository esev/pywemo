...
class ArgumentType:
    ...
    def from_argument(
        ...
        """Parse and validate service_parser.ArgumentType."""
        return cls(
...
class ActionProperties:
    ...
    def from_action(
        ...
        """Parse and validate service_parser.ActionType."""
...
class ServiceDescription:
    ...
    def from_xml(cls, service_xml_content: bytes) -> ServiceDescription:
        """Parse and validate service_parser.scpd."""
        try:
...
class ServiceProperties:
    ...
    def from_service(
        ...
        """Parse and validate device_parser.serviceType."""
        return cls(
...
class DeviceDescription:
    ...
    def dict_from_xml(setup_xml_content: bytes) -> dict[str, Any]:
        """Parse and validate DeviceType xsd type."""
        try:
